...
public class QualityOfLBNPool extends GenericObjectPool<QualityOfLBN> {
     ...
     */
    public QualityOfLBNPool(SeetaConfSetting config) {

        super(new PooledObjectFactory<QualityOfLBN>() {
            ...
            public PooledObject makeObject() throws Exception {
                QualityOfLBN detector = new QualityOfLBN(config.getSeetaModelSetting());
             ...
             */
            @Override
            public boolean validateObject(PooledObject<QualityOfLBN> pooledObject) {
                QualityOfLBN object = pooledObject.getObject();
             ...
             */
            @Override
            public void activateObject(PooledObject<QualityOfLBN> pooledObject) throws Exception {
                QualityOfLBN object = pooledObject.getObject();
                long impl = object.impl;
            }
