...
public class MaskDetectorPool extends GenericObjectPool<MaskDetector> {
     ...
     */
    public MaskDetectorPool(SeetaConfSetting config) {

        super(new PooledObjectFactory<MaskDetector>() {
            ...
            public PooledObject makeObject() throws Exception {
                MaskDetector detector = new MaskDetector(config.getSeetaModelSetting());
             ...
             */
            @Override
            public boolean validateObject(PooledObject<MaskDetector> pooledObject) {
                MaskDetector object = pooledObject.getObject();
             ...
             */
            @Override
            public void activateObject(PooledObject<MaskDetector> pooledObject) throws Exception {
                MaskDetector object = pooledObject.getObject();
                long impl = object.impl;
            }
